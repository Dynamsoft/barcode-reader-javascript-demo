...
.dbr-copyright {
  ...
  .dbr-product-info-in-mobile-part1,
  .dbr-product-info-in-mobile-part2,
  .dbr-product-info-in-mobile-part3 {
    font-size: 12px;
    font-family: "OpenSans-Regular";
    color: #aaaaaa;
    margin-bottom: 10px;
